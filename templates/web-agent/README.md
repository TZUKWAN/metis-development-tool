...
from an MDT BuildBlueprint (01990000-7000-7000-8000-000000000001). Plain files, no MDT runtime
...
| ----- | ----- | ---------------- |
| Research Agent | `gpt-5.1` via `openai` | datetime, web_fetch, web_search |
