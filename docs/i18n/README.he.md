...
**להורדה:** [macOS](https://github.com/TZUKWAN/metis-development-tool/releases/latest) ‏(Apple Silicon ו-Intel) ·
[Windows](https://github.com/TZUKWAN/metis-development-tool/releases/latest) ‏(x64 ו-Arm) ·
...
<td dir="rtl"><b>התקינו פעם אחת, מתוך הגדרות → שילובים</b> — GenOffice מציגה את סוכני הקוד שהיא מוצאת על המחשב הזה וכותבת את ה-skill לכל אחד שתבחרו. או הורידו את ה-skill כ-zip, או הריצו <code>npx skills add TZUKWAN/metis-development-tool</code>. הפקודות ותהליך העבודה המלא נמצאים ב<a href="#command-line-and-agent-skill">שורת הפקודה וה-skill לסוכנים</a>.</td>
</tr>
</table>
...
| `npx skills add TZUKWAN/metis-development-tool` | מתקין מהמאגר הזה לכל סוכן שתומך ב-skills.                                                                                                           |
...
| ------------------------------------ | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                                 | [הגרסה האחרונה של `.dmg` (arm64)](https://github.com/TZUKWAN/metis-development-tool/releases/latest)     |
| **macOS** — Intel (x64)              | macOS 11+                                                 | [הגרסה האחרונה של `.dmg` (x64)](https://github.com/TZUKWAN/metis-development-tool/releases/latest)       |
| **Windows** (x64, רוב המחשבים)       | Windows 10+, Intel/AMD                                    | [הגרסה האחרונה של מתקין `-x64.exe`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)   |
| **Windows** על Arm (ARM64)           | Windows 11 על Arm (Snapdragon X ומעבדים דומים)            | [הגרסה האחרונה של מתקין `-arm64.exe`](https://github.com/TZUKWAN/metis-development-tool/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64,‏ glibc 2.34+‎ (Ubuntu 22.04 ואילך)                | [הגרסה האחרונה של `.deb`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)             |
| **Linux** — Fedora / RHEL / openSUSE | x86_64,‏ glibc 2.34+‎ (Fedora 35+,‏ RHEL 9+,‏ Leap 15.6+) | [הגרסה האחרונה של `.rpm`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)             |
| **Linux** — הפצות אחרות              | x86_64,‏ glibc 2.34+‎, FUSE 2                             | [הגרסה האחרונה של `.AppImage`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)        |
