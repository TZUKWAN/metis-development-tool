...
**À télécharger :** [macOS](https://github.com/TZUKWAN/metis-development-tool/releases/latest) (Apple Silicon et Intel) ·
[Windows](https://github.com/TZUKWAN/metis-development-tool/releases/latest) (x64 et Arm) ·
...
<td><b>Installez une fois, depuis Réglages → Intégrations</b> — GenOffice liste les agents de codage qu'il trouve sur cet ordinateur et écrit le skill dans chacun de ceux que vous choisissez. Ou téléchargez le skill en zip, ou lancez <code>npx skills add TZUKWAN/metis-development-tool</code>. Les commandes et le flux de travail complet sont dans <a href="#command-line-and-agent-skill">Ligne de commande et skill d'agent</a>.</td>
</tr>
</table>
...
| `npx skills add TZUKWAN/metis-development-tool`         | Installe depuis ce dépôt dans tout agent compatible avec les skills.                                                                                                                                              |
...
| ------------------------------------ | ----------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Dernier `.dmg` (arm64)](https://github.com/TZUKWAN/metis-development-tool/releases/latest)            |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Dernier `.dmg` (x64)](https://github.com/TZUKWAN/metis-development-tool/releases/latest)              |
| **Windows** (x64, la plupart des PC) | Windows 10+, Intel/AMD                                | [Dernier installateur `-x64.exe`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)   |
| **Windows** sur Arm (ARM64)          | Windows 11 sur Arm (Snapdragon X et similaires)       | [Dernier installateur `-arm64.exe`](https://github.com/TZUKWAN/metis-development-tool/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 ou plus récent)     | [Dernier `.deb`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)                    |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Dernier `.rpm`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)                    |
| **Linux** — autres distributions     | x86_64, glibc 2.34+, FUSE 2                           | [Dernier `.AppImage`](https://github.com/TZUKWAN/metis-development-tool/releases/latest)               |
