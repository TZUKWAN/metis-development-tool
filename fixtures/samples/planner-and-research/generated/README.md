...
from an MDT BuildBlueprint (a0000000-0000-7000-8000-000000000021). Plain files, no MDT runtime
...
| ----- | ----- | ---------------- |
| Planner Agent | `gpt-4.1-mini` via `openai` | — |
| Research Agent | `gpt-4.1-mini` via `openai` | web_search |
