...
Generated from `MDT_1.0_TASKLIST.md`. One row per task ID, no omissions.

Status vocabulary: `TODO / IN_PROGRESS / BLOCKED / DONE / REOPENED`. A task is marked **DONE** only after its acceptance criteria in the tasklist are all met, with the real verification command and result recorded.

Sub-agent policy: at most **3** concurrent sub-agents (slots A=upstream/designer, B=runtime/capability, C=codex/testing). The main agent owns integration review, testing and final acceptance.
...
| P00.03 | TODO | main-agent |  |  |  |  |
| P00.04 | TODO | main-agent |  |  |  |  |
| P00.05 | TODO | main-agent |  |  |  |  |
...
| P01.06 | TODO | main-agent |  |  |  |  |
| P01.07 | TODO | main-agent |  |  |  |  |
| P01.08 | TODO | main-agent |  |  |  |  |
| P01.09 | TODO | main-agent |  |  |  |  |
| P01.10 | TODO | main-agent |  |  |  |  |

## P02 — GenOffice 基线复现与依赖审计

| ID | Status | Owner | Started | Completed | Verification command | Result / Notes |
| --- | --- | --- | --- | --- | --- | --- |
| P02.01 | TODO | main-agent |  |  |  |  |
| P02.02 | TODO | main-agent |  |  |  |  |
| P02.03 | TODO | main-agent |  |  |  |  |
| P02.04 | TODO | main-agent |  |  |  |  |
| P02.05 | TODO | main-agent |  |  |  |  |
| P02.06 | TODO | main-agent |  |  |  |  |
| P02.07 | TODO | main-agent |  |  |  |  |
| P02.08 | TODO | main-agent |  |  |  |  |
| P02.09 | TODO | main-agent |  |  |  |  |
...
| ID | Status | Owner | Started | Completed | Verification command | Result / Notes |
| --- | --- | --- | --- | --- | --- | --- |
| P03.01 | TODO | main-agent |  |  |  |  |
| P03.02 | TODO | main-agent |  |  |  |  |
| P03.03 | TODO | main-agent |  |  |  |  |
| P03.04 | TODO | main-agent |  |  |  |  |
| P03.05 | TODO | main-agent |  |  |  |  |
...
| ID | Status | Owner | Started | Completed | Verification command | Result / Notes |
| --- | --- | --- | --- | --- | --- | --- |
| P04.01 | TODO | main-agent |  |  |  |  |
| P04.02 | TODO | main-agent |  |  |  |  |
| P04.03 | TODO | main-agent |  |  |  |  |
| P04.04 | TODO | main-agent |  |  |  |  |
| P04.05 | TODO | main-agent |  |  |  |  |
| P04.06 | TODO | main-agent |  |  |  |  |
| P04.07 | TODO | main-agent |  |  |  |  |
| P04.08 | TODO | main-agent |  |  |  |  |
| P04.09 | TODO | main-agent |  |  |  |  |
| P04.10 | TODO | main-agent |  |  |  |  |
| P04.11 | TODO | main-agent |  |  |  |  |
| P04.12 | TODO | main-agent |  |  |  |  |
| P04.13 | TODO | main-agent |  |  |  |  |
| P04.14 | TODO | main-agent |  |  |  |  |
| P04.15 | TODO | main-agent |  |  |  |  |

## P05 — 项目读写、Autosave、恢复与资源管理

| ID | Status | Owner | Started | Completed | Verification command | Result / Notes |
| --- | --- | --- | --- | --- | --- | --- |
| P05.01 | TODO | main-agent |  |  |  |  |
| P05.02 | TODO | main-agent |  |  |  |  |
| P05.03 | TODO | main-agent |  |  |  |  |
| P05.04 | TODO | main-agent |  |  |  |  |
| P05.05 | TODO | main-agent |  |  |  |  |
| P05.06 | TODO | main-agent |  |  |  |  |
| P05.07 | TODO | main-agent |  |  |  |  |
| P05.08 | TODO | main-agent |  |  |  |  |
...
| ID | Status | Owner | Started | Completed | Verification command | Result / Notes |
| --- | --- | --- | --- | --- | --- | --- |
| P08.01 | TODO | main-agent |  |  |  |  |
| P08.02 | TODO | main-agent |  |  |  |  |
...
| P08.10 | TODO | main-agent |  |  |  |  |
| P08.11 | TODO | main-agent |  |  |  |  |
| P08.12 | TODO | main-agent |  |  |  |  |
| P08.13 | TODO | main-agent |  |  |  |  |
